...
export function ToggleGroupSingle({
  ...
  return <ToggleGroup type="single" value={value} onValueChange={handleValueChange} {...props} />
}
...
export function ToggleGroupMultiple({
  ...
  return <ToggleGroup type="multiple" value={value} onValueChange={handleValueChange} {...props} />
}
