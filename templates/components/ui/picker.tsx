...
import { Modal, Pressable, TextInput, TextStyle, TouchableOpacity, ViewStyle } from "react-native"
            ...
            style={[
              {
                fontSize: FONT_SIZE,
                color:
                  selectedOptions.length > 0 ? text : disabled ? muted : error ? danger : muted,
              },
              inputStyle,
            ]}
            numberOfLines={1}
